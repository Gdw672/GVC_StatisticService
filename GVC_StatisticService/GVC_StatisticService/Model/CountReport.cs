...
namespace GVC_StatisticService.Model
{
    public class CountReport
    {
        ...
        public CountReport(double входной_поток_всего, double цифровые_сервисы_всего, double роботы, double чат_боты, double входной_поток_АС_ОЗ, double цифровые_сервисы_АС_ОЗ, double входной_поток_не_АС_ОЗ, double цифровые_сервисы_не_АС_ОЗ, double самостоятельность, DateTime? дата_отчета)
        {
